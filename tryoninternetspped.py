...
Original file is located at
    https://colab.research.google.com/drive/1MERHYItiRYFms3G6VwUDSA9ehMw7xskC
"""

import requests as rq
r=rq.get('https://fast.com')
r.content
#y=[i for i in data if i=='id="speed-value"']
